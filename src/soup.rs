...
use crate::search::{
    find_all_compat, find_all_compat_node_ids, find_first_compat, has_search, is_sequence_filter,
...
use pyo3::types::{PyAny, PyAnyMethods, PyBytes, PyDict, PyDictMethods, PyList, PyString, PyTuple};
use regex::Regex;
